...
from .serializers import CourseListSerializer, CourseDetailSerializer, LessonListSerializer, CommentListSerializer, CategorySerializer
...
def get_categories(request):
    ...
    seralizer = CategorySerializer(categories, many=True)
